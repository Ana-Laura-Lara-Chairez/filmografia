      ...
      <div className="bg-white p8 rounded-lg drop-shadow-xl">
        ...
        <header className="w-full">
          <p> <span className="font-xl font-bold mb-3 mt-10">Pais de origen: </span>{filmografia?.pais}</p>
            <h1 className="text-4xl font-semibold mb-3 mt-5 text-blue-80">{filmografia?.title}</h1>
          <p> <span className="font-xl font-bold mb-3 mt-10">Nombre original: </span>{filmografia?.title}</p>
