...
export const SearchBar: FC<Props> = ({ onDebounce }) => {
    ...
    return (
        ...
        <div className="relative">
            ...
            <input type="search" id="default-search" className="block min-w-[35%] p-1.5 pl-10 mr-20 text-bg text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Buscar película..." required value={search}
